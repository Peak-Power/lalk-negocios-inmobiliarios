...
public class VentanaBuscadorDirecciones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaBuscadorDirecciones frame = new VentanaBuscadorDirecciones();
    ...
    String filtro=""+texto+"_%";
     SQL="SELECT "
    		...
    		+ "WHERE inm.estadoDisponibilidad='Disponible' AND inm.direccion LIKE"+'"'+filtro+'"'+"ORDER BY precioLista";
 	...
 	SQL="SELECT "
    		...
    		+"WHERE estadoDisponibilidad='Disponible' AND inm.direccion LIKE"+'"'+filtro+'"'+"ORDER BY precioLista";
...
//			fila[12]=rs.getString("estadoConservacion");
  ...
  //***************************************************//
	...
	public VentanaBuscadorDirecciones() {
...
//				68, 37, 179, 138
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaBuscadorDirecciones.class.getResource("/grafica/ventanas/uy2.png")));
		...
		contentPane.add(button_4);
	     ...
	     frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	       ...
	       ImageIcon imagen4 = new ImageIcon(VentanaBuscadorDirecciones.class.getResource("flecha.png"));
			...
			//------------------------------------ FLECHA CON ACCION ------------------------------//
		       ...
		       ImageIcon imagenFlecha = new ImageIcon(VentanaBuscadorDirecciones.class.getResource("flecha.png"));
		       ...
		       JLabel lblBarrio = new JLabel("Calle:");
